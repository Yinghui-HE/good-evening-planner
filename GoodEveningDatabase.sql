...
INSERT INTO EveningEvents (title, location, duration, category, subCategory, timeDependant, pictureURL, startTime, endTime)
    VALUES ('Griffith Observatory', '2800 E Observatory Rd Los Angeles, CA 90027', 120, 'Sightseeing', 'Urban', 0, 'https://www.visitcalifornia.com/sites/default/files/styles/welcome_image/public/vc_spotlight_griffithpark_module1_observatory_rf_601930068_1280x640.jpg', 1700, 1900),
                    ('Griffith Observatory', '2800 E Observatory Rd Los Angeles, CA 90027', 120, 'Sightseeing', 'Urban', 0, 'https://www.visitcalifornia.com/sites/default/files/styles/welcome_image/public/vc_spotlight_griffithpark_module1_observatory_rf_601930068_1280x640.jpg', 1940, 2140),
                    ...
                    ('Echo Mountain', 'Echo Mountain (Mount Lowe Railroad Trail), Altadena, CA 91001', 120, 'Sightseeing', 'Outdoors', 0, 'https://images1.laweekly.com/imager/u/745xauto/6044483/echo-mountain-best-night-hike-clarissa-wei.jpg', 2010, 2210),
...
INSERT INTO EveningEvents (title, location, duration, category, subCategory, timeDependant, pictureURL, startTime, endTime)
    VALUES ('Getty Center','1200 Getty Center Dr, Los Angeles, CA 90049', 120, 'Exhibition', 'Art', 0, 'http://news.getty.edu/content/1208/images/gettyvillaatnightcollegenight.jpg', 1800, 2000),
                    ('Natural History Museum', '900 W Exposition Blvd, Los Angeles, CA 90007',  120, 'Exhibition', 'History',0, 'https://www.ioes.ucla.edu/wp-content/uploads/nhmla_pic.jpg', 1630, 1830),
...
INSERT INTO EveningEvents (title, location, startTime, endTime, duration, category, subCategory, timeDependant, pictureURL)
    VALUES ('Laugh Factory - Open Mic', '8001 Sunset Blvd, Los Angeles, CA 90046',1800, 2000, 120, 'Show', 'Comedy', 1, 'https://upload.wikimedia.org/wikipedia/commons/thumb/c/c7/Laugh_Factory_at_Night.jpg/1200px-Laugh_Factory_at_Night.jpg'),
                    ...
                    ('Laugh Factory - The Kevin Nealon Show', '8001 Sunset Blvd, Los Angeles, CA 90046',2200, 2330, 90, 'Show', 'Comedy', 1, 'https://upload.wikimedia.org/wikipedia/commons/thumb/c/c7/Laugh_Factory_at_Night.jpg/1200px-Laugh_Factory_at_Night.jpg'),
...
INSERT INTO EveningEvents (title, location, duration, startTime, endTime, category, subCategory, timeDependant, pictureURL)
    VALUES ('Ralph Breaks the Internet', '1000 W. Olympic Blvd., Los Angeles, CA 90015', 112, 2040, 2228, 'Movie', 'Animated', 1, 'https://www.posteraddiction.com/wp-content/uploads/2018/11/Ralph-Breaks-the-Internet-Textless-2018-1.jpg'),
                    ('Ralph Breaks the Internet', '189 The Grove Drive, Los Angeles, CA 90036', 112, 1600, 1748, 'Movie', 'Animated', 1, 'https://www.posteraddiction.com/wp-content/uploads/2018/11/Ralph-Breaks-the-Internet-Textless-2018-1.jpg'),
                    ...
                    ('Fantastic Beasts: The Crimes of Grindelwald', '1000 W. Olympic Blvd., Los Angeles, CA 90015', 134, 1900, 2114, 'Movie', 'Adventure', 1, 'https://cnet2.cbsistatic.com/img/-pwsqw4MNJ_iGialcDFO9VQik1I=/1600x900/2018/11/09/86f0f89e-57b7-417e-ab2b-ee856539b567/fullcast.jpg'),
                    ('Fantastic Beasts: The Crimes of Grindelwald', '189 The Grove Drive, Los Angeles, CA 90036', 134, 2230, 2444, 'Movie', 'Adventure', 1, 'https://cnet2.cbsistatic.com/img/-pwsqw4MNJ_iGialcDFO9VQik1I=/1600x900/2018/11/09/86f0f89e-57b7-417e-ab2b-ee856539b567/fullcast.jpg'),
...
INSERT INTO EveningEvents (title, location, duration, category, subCategory, timeDependant, pictureURL, startTime, endTime)
    VALUES ('Westfield Century City', '10250 Santa Monica Blvd, Los Angeles, CA 90067', 120, 'Shopping', '$$$', 0, 'https://www.discoverlosangeles.com/sites/default/files/media/activities/shopping/westfield_century_city_nordstrom_rendering.jpg', 1800, 2000),
                    ...
                    ('Glendale Galleria', '100 W Broadway, Glendale, CA 91210', 120, 'Shopping', '$$', 0, 'https://c2.staticflickr.com/4/3272/3053770105_83db62d2b9_z.jpg', 1600, 1800),
...
INSERT INTO EveningHistory (userID, startTime, endTime, eventID1, eventID2 ,eventID3 , inUse)
    VALUES (2, 1630, 2300, 54, 20, 71, 1);     
     
     
INSERT INTO EveningHistory (userID, startTime, endTime, eventID1, eventID2 ,eventID3 ,eventID4 , inUse)
    VALUES (1, 1830, 2100, 1, 2, 1, 3, 1),
                    (1, 1900, 2300, 3, 4, 1, 2, 1),
                    (1, 1830, 2000, 1, 2, 1, 3, 1),
                    (1, 1935, 2300, 3, 4, 1, 2, 1),
                    (1, 1930, 2300, 3, 4, 1, 2, 1),
                    (2, 1600, 2330, 1, 15, 12, 7, 1),
                    (2, 1600, 2330, 10, 24, 4, 92, 1);
